...
// Defines values for ListTaskParamsSort.
const (
	ListTaskParamsSortCreatedAt      ListTaskParamsSort = "createdAt"
	ListTaskParamsSortMinusCreatedAt ListTaskParamsSort = "-createdAt"
)
...
type ListTaskParams struct {
	Sort ListTaskParamsSort `form:"sort" json:"sort"`
}

// ListTaskParamsSort defines parameters for ListTask.
type ListTaskParamsSort string
